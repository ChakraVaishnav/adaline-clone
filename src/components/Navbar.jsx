    ...
    return (
        <nav className={`pointer-events-auto sticky top-0 right-0 left-0 h-0 z-50 transition-shadow duration-200 ${isScrolled ? 'shadow-[0_1px_0_0_rgba(0,0,0,0.1)]' : ''}`}>
            <div className="h-16 relative">
                <div className="absolute inset-0 z-20 flex flex-row items-center justify-center px-6 lg:px-8">
                    {/* Logo */}
                    <a className="flex-none overflow-hidden" aria-label="Adaline Homepage" href="/">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 84 15" className="text-[#2D5016] h-5">
                    ...
                    <div className="flex flex-1 items-center justify-end gap-8">
                        <div className="hidden md:flex items-center gap-2">
                            ...
                            <div className="relative">
                                <button className="inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-[20px] cursor-pointer transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none shrink-0 h-8 px-3.5 gap-2 bg-transparent border border-[#D4C5B0] text-[#2D5016] hover:text-[#3D6020] hover:border-[#C4B5A0] disabled:border-[#D4C5B0] disabled:bg-transparent disabled:text-[#B0A090] ring-offset-[#F5F1E8] focus-visible:ring-[#2D5016] pl-5 font-mono text-sm">
                                    Demo
                                    <div className="-mr-2.5 ml-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#D4C5B0]">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="text-[#2D5016] w-4 h-4">
                            ...
                            <button className="inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-[20px] cursor-pointer transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none shrink-0 h-8 px-3.5 gap-2 bg-[#2D5016] text-[#F5F1E8] hover:bg-[#3D6020] disabled:bg-[#E5E1D8] disabled:text-[#B0A090] ring-offset-[#F5F1E8] focus-visible:ring-[#2D5016] font-mono text-sm">
                                Start for free
                            </button>
                        ...
                        <div className="flex md:hidden items-center gap-2">
                            <button className="inline-flex items-center justify-center gap-3 whitespace-nowrap rounded-[20px] cursor-pointer transition-colors shrink-0 h-8 px-3.5 bg-[#2D5016] text-[#F5F1E8] hover:bg-[#3D6020] font-mono text-sm">
                                Start for free
                            </button>
                            <button
                                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
